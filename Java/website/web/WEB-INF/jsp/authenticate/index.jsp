        ...
        <div class="form-group">
            ...
            <div class="col-xs-3">
                ...
                <select class="form-control" id="BankId.LOA" name="BankId.LOA">
                    <option selected="selected">Loa3</option>
                </select>
            </div>
            <div class="col-xs-3">
                <label for="issuerID">BankId.DocumentId</label>
                <input class="form-control" id="BankId.DocumentId" name="BankId.DocumentId" type="text" value="">
            </div>
        </div>
